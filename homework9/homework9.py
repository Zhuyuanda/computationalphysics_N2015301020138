...
plt.plot(x_j,y_j,label="Jupiter",color='gold')
plot(x_s,y_s,label="Sun",color='red')
legend(('Earth','Jupiter','Sun'),loc='upper left')
title('three-body trajectory with Mj*1000',fontsize=15)
xlabel('x/AU')
#xlim(-6,6)
ylabel('y/AU')
#ylim(-6,6)
