...
figure(figsize=(12,9))
scatter(theta_array1,omega1_array1,label="Force=0",color="green",marker=".")
scatter(theta_array2,omega2_array2,label="Force=0.5",color="red",marker=".")
scatter(theta_array3,omega3_array3,label="Force=1.2",color="purple",marker=".")
